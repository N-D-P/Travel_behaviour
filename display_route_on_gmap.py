...
lbl = tk.Label(root, text="Google Map Route", font=('times', 40,' bold '), height=1, width=30,bg="lightblue2",fg="indian red")
lbl.place(x=230, y=10)

frame_alpr = tk.LabelFrame(root, width=680, height=300, bd=5, font=('times', 15, ' bold '),bg="lightblue1")
