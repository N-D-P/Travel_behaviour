...
#
label_l1 = tk.Label(root, text="Travel Behaviour using machine learning",font=("Times New Roman", 35, 'bold'),
...
def reg():
    from subprocess import call
    call(["python","women_registration.py"])

def log():
    from subprocess import call
    call(["python","women_login.py"])
