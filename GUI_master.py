...
root = tk.Tk()
root.title("Travel Behaviour using machine learning")
...
lbl = tk.Label(root, text="Travel Behaviour using machine learning", font=('times', 35,' bold '), height=1, width=32,bg="White",fg="Black")
lbl.place(x=300, y=10)
# _+++++++++++++++++++++++++++++++++++++++++++++++++++++++
data = pd.read_csv("C:/Users/anshp/OneDrive/Desktop/BE Projec/Travel_behaviour_using_ml/Travel_behaviour_using_ml/route1.csv")
...
def Model_Training():
    ...
    label5 = tk.Label(root,text ="Accracy : "+str(ACC)+"%\nModel saved as Route_MODEL.joblib",width=45,height=3,bg='khaki',fg='black',font=("Tempus Sanc ITC",14))
    label5.place(x=205,y=420)
    from joblib import dump
    dump (svcclassifier,"Route_MODEL.joblib")
...
button4 = tk.Button(root, foreground="white", background="black", font=("Tempus Sans ITC", 14, "bold"),
                    text="Travel behaviour", command=call_file, width=15, height=2)
